...
export default function APanel() {
    ...
    return (
        <aside className="w-full md:w-64 bg-white border-r border-cyan-100 flex flex-col shadow-sm shrink-0 z-10 h-full font-sans">
            <div className="p-6 border-b border-cyan-50 text-left">
            ...
            <Link
                to="/"
                className="group flex items-center justify-center gap-2 p-4 mt-auto text-[10px] font-black uppercase tracking-widest text-slate-500 bg-slate-50 border-t border-slate-100 hover:bg-cyan-50 hover:text-cyan-700 transition-all duration-300"
            >
